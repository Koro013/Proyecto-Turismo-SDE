...
<body class="bg-body bebas-neue-regular">
          ...
          <div id="carouselTurismoSantiago" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner border-carrousel img-carrousel">
              ...
              <div class="carousel-item conteiner-img-carrousel" data-bs-interval="5000">
                <img src="./img/cancha-hockey.jpg" class="d-block w-100 h-100 p-img-carrousel"
  ...
  <main class="container pb-3 separacion-texto">
      ...
      <div class="card mi-tajeta nav-color">
        ...
        <div class="row card-body bg-transparent justify-content-center px-5 px-lg-0 px-sm-5 py-4">
          ...
          <a href="destino.php?id=1"
            class="card btn btn-light p-0 mx-lg-1 mb-lg-0 mx-md-3 mb-3 col-lg-3 col-xl-3 tarjeta-inicio">
          ...
          <a href="destino.php?id=2"
            class="card btn btn-light p-0 mx-lg-1 mb-lg-0 mx-md-3 mb-3 col-lg-3 col-xl-3 tarjeta-inicio">
            <img src="./img/cancha-hockey.jpg" class="card-img-top tarjeta-imagen" alt="Estadio-de-Hockey">
            <div class="card-body">
          ...
          <div>
            <a href="destinos.php">
              <button type="button" class="btn btn-light fs-3 mt-lg-5 mt-3 col-10 col-md-6 col-lg-8 col-xl-6 separacion-texto">Ver Más</button>
            </a>
          </div>
        ...
        <div class="card bg-dark-subtle text-light p-0" style="border: 0px; border-radius: 12px;">
          <div class="card-body tarjeta-centro p-0">
            ...
            <div class="row mx-0">
              ...
              <div class="col-5 px-0">
                <img src="./img/cancha-hockey.jpg"
                  class="d-block w-100 h-100 p-img-carrousel border-tarjeta botones-cuerpo" alt="Estadio-de-Hockey">
              </div>
    ...
    <a href="https://t.me/TurismoSDE_bot" target="_blank">
      <section class="mb-5">
        <div class="card bg-dark-subtle text-light p-0" style="border: 0px; border-radius: 12px">
          <div class="card-body tarjeta-centro p-0">
